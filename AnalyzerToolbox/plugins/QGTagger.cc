...
QGTagger::QGTagger(const edm::ParameterSet& iConfig) :
  ...
  dataDir        ( TString(iConfig.getUntrackedParameter<std::string>("dataDir","JetTools/AnalyzerToolbox/data/"))), 
...
void QGTagger::fillDescriptions(edm::ConfigurationDescriptions& descriptions){
  ...
  desc.addUntracked<std::string>("dataDir","JetTools/AnalyzerToolbox/data/");
