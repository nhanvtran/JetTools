...
#include "JetTools/AnalyzerToolbox/interface/QGTagger.h"
#include "JetTools/AnalyzerToolbox/interface/QGLikelihoodCalculator.h"
#include "JetTools/AnalyzerToolbox/interface/QGMLPCalculator.h"
...
QGTagger::QGTagger(const edm::ParameterSet& iConfig) :
  ...
  dataDir        ( TString(iConfig.getUntrackedParameter<std::string>("dataDir","JetTools/AnalyzerToolbox/data/QGTagger/"))), 
...
void QGTagger::fillDescriptions(edm::ConfigurationDescriptions& descriptions){
  ...
  desc.addUntracked<std::string>("dataDir","JetTools/AnalyzerToolbox/data/QGTagger/");
